    ...
    try:
        ...
        try:
            supabase.table("audit_logs").insert({
                "action": "final_hr_offer_approved",
            ...
            print("AUDIT LOG ERROR:", audit_error)
...
def hr_reject_offer(
    ...
    try:
        ...
        try:
            supabase.table("audit_logs").insert({
                "action": "final_hr_offer_rejected",
                "staff_user_id": staff.get("id"),
                "table_name": "applications",
                "record_id": real_app_uuid,
...
def hr_verify_document(
    ...
    try:
        ...
        try:
            ...
            raise HTTPException(
                status_code=500,
                detail="Unable to retrieve document from Supabase Storage.",
            )
...
"""
        ...
        try:
            ...
            raise HTTPException(
                status_code=500,
                detail=f"AI document verification failed: {gemini_error}",
            )
        ...
        print("DOCUMENT AI VERIFICATION ERROR:", error)
...
def run_recruitment_inbox_listener():
    ...
    while True:
        try:
            ...
            print("RECRUITMENT INBOX WATCHER ERROR:", e)
        time.sleep(30)
